    ...
    return(
        <div id="projects" className="flex flex-col items-center lg:items-stretch">
            <div id= "projects-card" className="m-10 w-3/4 lg:w-auto bg-red-50 bg-opacity-75 shadow-md rounded-md flex flex-col items-center">
                ...
                <div className="flex flex-row flex-wrap items-center justify-center lg:items-stretch ">
                {projects.map((project, index) => (
                        <div key={index} className="bg-olive bg-opacity-75 shadow-lg m-8 w-3/4 lg:w-1/4 flex flex-col items-center transform hover:scale-110 transition duration-700">
